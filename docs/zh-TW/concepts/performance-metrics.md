...
!!! info
    本頁解釋了最重要的幾個績效指標，幫助你判斷一個策略是否值得交易。內容涵蓋報酬、風險與綜合評估指標，以及常見的回測陷阱。
